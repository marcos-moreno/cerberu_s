Public Class frmBuscaCaracteristica
    Public objRetorno As Caracteristica
    Public Ambiente As AmbienteCls
    Public tabla As String

    Private objDgv As New List(Of Caracteristica)

    Private Sub frmBuscaCaracteristica_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        objRetorno = New Caracteristica(Ambiente)
        objRetorno.tabla = tabla
        objRetorno.idEmpresa = Ambiente.empr.idEmpresa
        filtrar()
    End Sub
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        If btnAgregar.Text = "Agregar Nuevo" Then
            ...
            objRetorno.tabla = tabla
            objRetorno.idEmpresa = Ambiente.empr.idEmpresa
            objRetorno.nombreCaracteristica = txtNombreCaracteristica.Text

            If objRetorno.guardar() Then
                filtrar()
                Mensaje.Mensaje = "Se agregó correctamente..."
                txtNombreCaracteristica.Text = ""
            Else
    ...
    Private Sub btn2Valor_Click(sender As Object, e As EventArgs) Handles btn2Valor.Click
        If btn2Valor.Text = "Eliminar" Then
            ...
            Mensaje.Mensaje = "¿Realmente desea eliminar """ & objRetorno.nombreCaracteristica & """?"
        ...
        Else
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                objRetorno = objDgv.Item(DataGridView1.SelectedRows.Item(0).Index)
                txtNombreCaracteristica.Text = objRetorno.nombreCaracteristica
            End If
        End If
    End Sub
