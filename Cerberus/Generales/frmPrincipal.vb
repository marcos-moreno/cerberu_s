...
Public Class frmPrincipal
    ...
    Private Sub frmPrincipal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblDetalle.Text = Ambiente.usuario.nombreCompleto & " | " & Ambiente.empr.nombreEmpresa & " | " & Ambiente.suc.nombreSucursal & " | " & Ambiente.conex.conexBuild(0).InitialCatalog & " | v1.3.1"
